        ...
        {stackArray.map((stack) => (
          ...
          >
            ...
            <div className="space-y-2">
              <h2 className="font-semibold text-md flex items-center space-x-1"><span>{stack.name}</span><ExternalLink size={12} className="hidden group-hover:block duration-300"/></h2>
